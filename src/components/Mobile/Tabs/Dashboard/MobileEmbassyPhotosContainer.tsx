...
class MobileEmbassyPhotosContainer extends Component<Props> {
    ...
    render() {
        return(<div className={"mobile-container"}>
            <MobileToolbar title={"Fotos da Embaixada"} goBack={this.goBack}/>
        </div>)
    }
}
...
export default connect (mapStateToProps, mapDispatchToProps) (MobileEmbassyPhotosContainer)